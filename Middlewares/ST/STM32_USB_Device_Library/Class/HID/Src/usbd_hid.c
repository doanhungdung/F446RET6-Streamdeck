...
{
  /* ---- Keyboard, Report ID 1 (6 phím + modifier) ---- */
  ...
  0x95, 0x06,        /*   Report Count (6) : 6 phím */
  ...
  /* ---- Consumer Control, Report ID 2 (volume + brightness) ---- */
  ...
  0x25, 0x01,        /*   Logical Maximum (1) */
  0x75, 0x01,        /*   Report Size (1) */
  0x95, 0x05,        /*   Report Count (5) : Vol+, Vol-, Mute, Bright+, Bright- */
  ...
  0x81, 0x02,        /*   Input (Data,Var,Abs) */
  0x95, 0x03,        /*   Report Count (3) : padding cho đủ byte */
  0x81, 0x01,        /*   Input (Cnst,Ary,Abs) */
  0xC0               /* End Collection */
};
